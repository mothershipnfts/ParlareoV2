...
export default function Packages() {
  ...
  const handlePurchase = async (pkg) => {
    ...
    if (profile) {
      ...
      setProfile(prev => ({ ...prev, lessons_remaining: (prev.lessons_remaining || 0) + pkg.lessons }));
    }

    setPurchasing(null);
    navigate(createPageUrl("BookLessons"));
  };
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#1a1b4b]">Lesson Packages</h1>
